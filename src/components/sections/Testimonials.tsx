    ...
    <section id="testimonies" className="py-32 bg-[#051d46] overflow-hidden cursor-grab active:cursor-grabbing">
       ...
       <div className="review-track flex gap-10 px-6 md:px-20 w-fit">
          {REVIEWS.map((review, i) => (
             <div key={i} className="w-[80vw] md:w-[30vw] shrink-0 p-10 border border-white/10 bg-white/5 backdrop-blur-sm rounded-xl hover:bg-white/10 transition-colors select-none">
